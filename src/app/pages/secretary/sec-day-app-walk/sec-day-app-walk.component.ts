...
@Component({
  ...
  templateUrl: './sec-day-app-walk.component.html',
  styleUrl: './sec-day-app-walk.component.css'
})
export class SecDayAppWalkComponent implements OnInit {
  selectedDate: string = '';
  timeSlots: any[] = [];
  docId!: number;
  clinicId: number = 0;
  ...
  bookTimeslot(timeSlot: any): void {
    this.router.navigate(['/sec-confirm-booking-walk'], {
      queryParams: {
