...
@Component({
  ...
  templateUrl: './sec-doc-app-walk.component.html',
  styleUrl: './sec-doc-app-walk.component.css'
})
export class SecDocAppWalkComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.subscribe(params => {
      ...
      console.log('Reschedule Flag:', this.isReschedule);
  ...
  goToDayAppointments(selectedDate: string): void {
    if (this.docId && this.patientId) {
      this.router.navigate(['/sec-appointments-walk', this.docId, selectedDate], {
        queryParams: {
